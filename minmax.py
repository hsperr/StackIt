...
class MinMax:
    ...
    def get_best_move(self, board):
        move, score, pv =  self._maxmimize(board, self.max_depth)
    ...
    def _maxmimize(self, board, depth):
        ...
        for move in board.possible_moves():
            ...
            _, score, local_pv = self._maxmimize(board, depth-1)
            ...
            if score > best_score:
                ...
                if self.debug:
                    print("******new best", move, score, principle_variation, 'depth', depth, 'current_player', board.current_player)
